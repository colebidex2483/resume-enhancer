  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-12">
        <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-600 sm:text-5xl mb-3">
      ...
      <div class="flex justify-center mb-8">
        <div class="inline-flex rounded-md bg-gray-800 p-1 shadow-lg">
          <button 
            ...
            class="px-6 py-3 rounded-md text-sm font-medium transition-all duration-300"
          >
      ...
      <!-- Resume Enhancer Tab -->
      <div v-if="activeTab === 'resume'" class="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-xl shadow-2xl p-6 mb-8 border border-gray-700 transition-all duration-500">
        <div class="mb-8">
        ...
        <div>
          ...
          <div v-if="jobInputMode === 'text'" class="mt-2">
            <label for="job-description" class="block text-sm font-medium text-gray-300 mb-1">
              Paste the job description below
            </label>
            <textarea id="job-description" v-model="jobDescriptionText" rows="8"
              class="bg-gray-700 text-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-600 rounded-md p-3 placeholder-gray-400"
        ...
        <div class="mt-8 flex justify-center">
          <button @click="enhanceResume" :disabled="!canSubmitResume" :class="{
            ...
            <svg v-if="isLoading" class="animate-spin -mr-1 ml-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- Upwork Proposal Tab -->
      <div v-if="activeTab === 'upwork'" class="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-xl shadow-2xl p-6 mb-8 border border-gray-700 transition-all duration-500">
        <div class="mb-8">
          <h2 class="text-xl font-medium text-white mb-4 flex items-center">
            <span class="bg-indigo-600 p-2 rounded-lg mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="mb-8">
          ...
          <p class="mt-2 text-sm text-gray-400">Tip: Use placeholders like [ClientName], [YourName], [YourExperience] that will be automatically replaced.</p>
        </div>
        ...
        <div class="mt-8 flex justify-center">
          <button @click="generateProposal" :disabled="!canSubmitProposal" :class="{
            ...
            <svg v-if="isLoadingProposal" class="animate-spin -mr-1 ml-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg"
              fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor"
                d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
        ...
        <!-- Proposal Result -->
        <div v-if="generatedProposal" class="mt-8 bg-gray-900 rounded-lg p-6 border border-gray-700">
